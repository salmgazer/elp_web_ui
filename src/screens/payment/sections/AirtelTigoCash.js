    ...
    return(
        <div>
            ...
            <Grid container spacing={1} className={classes.root} >
                <Grid item xs={3}>
                    <Paper className={classes.paper} onClick={openCreditCard.bind(this)} >
                ...
                <div className="row p-3 pt-0 mx-auto text-center w-100" >
                    ...
                    <div className="text-center mx-auto my-3">
                        <Typography
                            ...
                            className={`text-center mb-2 mx-auto w-90 `}
                        >
                            Sorry! You cannot access your account until you have paid this month's subscription fee of
                        </Typography>

                        <Typography
                            component="p"
                            variant="h6"
                            style={{fontSize: '22px' , margin: '0px 0px', padding: '10px'}}
