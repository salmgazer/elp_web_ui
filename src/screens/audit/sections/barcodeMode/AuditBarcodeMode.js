...
import SingleProductMainCard from "../../../sell/sell/sections/singleProductMainCard";
import ProductCard from "../../../../components/Cards/ProductCard";
import AuditService from "../../../../services/AuditService";
import BranchProductService from "../../../../services/BranchProductService";


const AuditBarcodeMode = props => {
                ...
                { barcodeProducts.length > 1 ? (
                        <Grid container spacing={1} className='mt-1'>
                            {barcodeProducts.map(item =>
                                ...
                                >
                                    <div
                                        onClick={addProductToCart.bind(this, item.productId)}
                                    >
                                        <ProductCard audit={true} appCounted={new AuditService().getAuditProductDetails(item.productId)} storeCounted={new BranchProductService(item).getProductQuantity()} product={item.product.fetch()}>
                                        </ProductCard>
                                    </div>
                                </Grid>
                            )}
...
export default AuditBarcodeMode;
