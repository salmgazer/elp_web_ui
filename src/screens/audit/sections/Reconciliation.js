...
import MainView from './reconciliationViews/MainView';
import ReconciliationReport from './reconciliationViews/ReconciliationReport';
import ReconciliationDetails from './reconciliationViews/ReconciliationDetails';
import ReconciliationHistory from './reconciliationViews/ReconciliationHistory';
...
class Reconciliation extends Component{
    ...
    getStepContent = step => {
        switch (step) {
            case 0:
                return <MainView setView={this.setStepContentView.bind(this)}  />;
            case 1:
