                ...
                >
                    ...
                    <Grid container>
                        <Grid item xs={6}>
                            <Button
                                variant="outlined"
                                style={{border: '1px solid #DAAB59', color: '#DAAB59', padding: '5px 20px', textTransform: 'none', fontSize:'15px'}}
                    ...
                    {checkButton === true
                        ?
                        <SellQuantityInput label={`Number of bottles`} inputName="quantity" max={quantityProduct} min={1} getValue={setInputValue.bind(this)}/>
                        :
                        <SellQuantityInput label={`Number of tots`} inputName="quantity" max={quantityProduct} min={1} getValue={setInputValue.bind(this)}/>
