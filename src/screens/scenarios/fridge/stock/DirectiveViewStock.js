...
import StockMainPage from "../../../../screens/stock/sections/stockMainPage";
import './stock.scss';
import LocalInfo from '../../../../services/LocalInfo';
import StockProductSingle from "../../../../screens/stock/sections/stockProductSingle";
import StockSummaryPage from "../../../../screens/stock/sections/itemsLeft/stockSummaryPage";
import ItemsOutOfStock from "../../../../screens/stock/sections/outOfStock/itemsOutOfStock";
import ItemsLowStock from "../../../../screens/stock/sections/lowStock/itemsLowStock";
import AddNewStockPage from "../../../../screens/stock/sections/addNewStockPage";
import AllStock from '../../../../screens/stock/sections/allStock/AllStock';
import MoveStock from "../../../../screens/stock/sections/moveStock/moveStock";
...
import AssignBarcode from '../../../../screens/stock/sections/AssignBarcode';
    ...
    * */
    getStepContent = step => {
        switch (step) {
            ...
            case 2:
                return <StockSummaryPage pageName='Fridge stock' itemsLeft={this.state.itemsLeft} storeDetails={this.state.storeDetails} setView={this.setStepContentView.bind(this)}/>;
            case 3:
                return <ItemsOutOfStock pageName='Fridge stock' addNewProductStockView={this.showProductStockView.bind(this)} stock={this.state.outOfStockItems} storeDetails={this.state.storeDetails} setView={this.setStepContentView.bind(this)}/>;
            case 4:
                return <ItemsLowStock pageName='Fridge stock' addNewProductStockView={this.showProductStockView.bind(this)} stock={this.state.lowestStockItems} storeDetails={this.state.storeDetails} setView={this.setStepContentView.bind(this)}/>;
            case 5:
                return <AddNewStockPage pageName='Fridge stock' product={this.state.currentProduct} updateProduct={this.updateNewProduct.bind(this)} setView={this.setStepContentView.bind(this)}/>;
            case 6:
            ...
            case 8:
                return <AllStock pageName='Fridge stock' setView={this.setStepContentView.bind(this)} searchProduct={this.searchProductHandler.bind(this)} branchProducts={this.state.branchProducts}/>
            default:
                return 'Complete';
        }
    };
