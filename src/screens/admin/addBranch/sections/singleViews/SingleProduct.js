...
const AddedProductSingle = props => {
    ...
    const image = `https://elparah.store/admin/upload/${addedProduct.image}`;
        ...
        <Grid container spacing={1} className={`shadow1 mb-3 borderRadius10`}>
            ...
            <Grid item xs={5} style={{display: 'table', height: '60px', margin: '8px 0px'}}>
                <div style={{textAlign: 'left', fontWeight: '600', display: 'table-cell', verticalAlign: 'middle'}}>
                    {addedProduct.name}
                    <div className="font-weight-light mt-1" style={{fontSize: '13px'}}>{addedProduct.amount} quantity counted </div>
                </div>
            </Grid>
