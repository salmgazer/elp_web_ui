...
import Styles from './ViewCustomers.module.scss';
                ...
                {({ state, setState }) => (
                    <React.Fragment>
                        ...
                        <SectionNavbars title={`Order history`}>
                            <ArrowBackIcon
                                onClick={() => history.push(paths.customer_details)}
                            />
                        </SectionNavbars>
                        ...
                        <div style={{ position: "fixed", top:"60px", width:"100%" }}>
                            ...
                            <Paper className={classes.paper} style={{padding: "3px 7px"}}>
                                <Grid container style={{padding: "10px", border: "1px solid #0000003b"}}>
                                    ...
                                    <Grid item xs={7} sm container style={{paddingBottom: "7px" , paddingLeft: "5px" }} onClick={() => history.push(paths.supplier_detail)}>
                                    ...
                                    <Grid item xs={5} sm>
                                        <div>
                                            ...
                                            <Button
                                                ...
                                                onClick={() => history.push(paths.order_details)}
                                            >
                                                View more
                                            </Button>
