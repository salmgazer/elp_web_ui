...
import WeekView from '../../../../history/salesHistory/sections/WeekView';
import MonthView from '../../../../history/salesHistory/sections/MonthView';
import YearView from '../../../../history/salesHistory/sections/YearView';
import SReturnSortProduct from './SReturnSortProduct';


class ReturnSortProduct extends Component{
    ...
    getStepContent = step => {
        switch (step) {
            case 4:
                return <SReturnSortProduct setView={this.setStepContentView.bind(this)} products={this.state.productList} />;
            case 0:
...
export default withRouter(ReturnSortProduct);