...
const ThisWeek = props => {
    ...
    console.log(format(firstday, 'MM/dd/yyyy'))
    ...
    const getCompanyDetails = async () => {
        const response = await new SaleService().getAllSalesToday('week', format(firstday, 'MM/dd/yyyy'));
...
export default withRouter(ThisWeek);